  ...
  return (
    <div className="relative bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 xl:max-w-2xl xl:w-full xl:pb-28 2xl:pb-32">
          <svg
      ...
      <div className="xl:absolute xl:inset-y-0 xl:right-0 xl:w-1/2 bg-gray-50">
        <div className="w-full h-full flex items-center justify-center p-6 sm:p-10 py-12">
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-lg">
                 ...
                 <div className="bg-white p-6 rounded-2xl shadow-xl flex flex-col items-center justify-center text-center transform hover:scale-105 transition duration-300 sm:translate-y-8">
