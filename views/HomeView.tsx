    ...
    <article className="animate-fade-in">
      ...
      <section className="bg-gray-50 dark:bg-slate-950 py-16 sm:py-24 border-t border-gray-100 dark:border-slate-800">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
              ...
              <article className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 text-sm leading-relaxed text-gray-600 dark:text-slate-400 font-medium">
                  <div>
                      <h3 className="font-bold text-gray-900 dark:text-white mb-4 text-lg">What is a Phone Verified Account (PVA)?</h3>
                  ...
                  <div>
                      <h3 className="font-bold text-gray-900 dark:text-white mb-4 text-lg">Why buy aged accounts?</h3>
