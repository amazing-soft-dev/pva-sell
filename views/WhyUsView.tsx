        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
           ...
           <div className="space-y-6">
              <div className="bg-white p-6 rounded-xl shadow-sm">
                 ...
                 <p className="text-gray-600">Absolutely not. All accounts are created by our team or our trusted partners using legitimate methods.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-sm">
                 <h3 className="font-bold text-gray-900 mb-2">How fast is delivery?</h3>
                 <p className="text-gray-600">Delivery is instant for 95% of our inventory. Custom orders take 1-3 days.</p>
              </div>
           </div>
        </div>
      </div>
